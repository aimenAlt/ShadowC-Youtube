...
<header
    class="flex px-4 border items-center h-[64px] py-2 bg-white z-10 justify-between sticky top-0 left-0"
>
    ...
    <div class="md:flex hidden gap-3 items-center">
        ...
        <img
                src="/avatar.png"
                class="bg-gray-200 h-8 w-8 rounded-full cursor-pointer"
                alt=""
        />
    </div>
</header>
