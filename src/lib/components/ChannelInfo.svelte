...
<div class="flex my-5 items-center justify-between">
    <div class="flex items-center gap-5">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="font-medium capitalize"> aimenALT</p>
                <p class="text-gray-700 text-xs">100 subs</p>
            </div>
        ...
        <div class="flex gap-3 items-center">
            <div class="divide-x-2 bg-gray-100 flex items-center overflow-hidden rounded-full">
                <button class=" hover:bg-gray-200 py-2 px-4 flex items-center gap-2">
                    ...
                    <span class="text-sm font-medium">9000 likes</span>
                </button>
                <button class=" hover:bg-gray-200 py-2 px-4 flex items-center gap-2">
                    <img src="/icons/dislikeIcon.svg" alt="">
                    <span class="text-sm font-medium">3000 likes</span>
                </button>
            </div>
            <button class=" hover:bg-gray-200 py-2 px-4 flex items-center gap-2 rounded-full">
                <img src="/icons/shareIcon.svg" alt="">
                <span class="text-sm font-medium">Share</span>
            </button>
            <button class=" hover:bg-gray-200 p-2 flex items-center gap-2 rounded-full">
